:project-name: miq-HP-ServerAutomation
:project-repo: https://github.com/rhtconsulting/miq-HP-ServerAutomation
:project-zip: https://github.com/rhtconsulting/miq-HP-ServerAutomation/archive/master.zip
